...
import net.utils.lr_policy as lr_policy


def construct_optimizer(model, cfg, model_name):
    """
    ...
    if model_name in ["Discriminator","D"]:
        init_Lr=cfg.Discriminator.INIT_LR
    elif model_name in ["Generator","G"]:
        init_Lr=cfg.Generator.INIT_LR
    else:
        raise NotImplementedError(
                "Does not init LR  in optimizer py ")
